...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Remove or comment out this node
        # Node(
        #     package='simple_planner',
        #     executable='custom_path_finding',  
        #     name='custom_path_finding',
        #     output='screen'
        # ),
        Node(
            package='rviz2',
            executable='rviz2',
            name='rviz2',
            arguments=['-d', '/home/zeeshan/rida_ws/install/simple_planner/share/simple_planner/config/visualization.rviz'],
            output='screen'
        ),
    ])